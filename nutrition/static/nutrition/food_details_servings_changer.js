...
function onClick() {
    ...
    document.getElementById("vita").innerHTML = "Vitamin A: " + vita + "%";
    document.getElementById("vitc").innerHTML = "Vitamin C: " + vitc + "%";
    document.getElementById("iron").innerHTML = "Iron: " + iron + "%";
    document.getElementById("calc").innerHTML = "Calcium: " + calc + "%";
