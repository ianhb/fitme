    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ManyToManyField(to='exercise.Equipment')),
            ],
        ),
        migrations.CreateModel(
            name='ExerciseLog',
            ...
            fields=[
                ...
                ('type',
                 models.CharField(choices=[('M', 'Maintenance'), ('B', 'Bulking'), ('C', 'Cutting')], default='M',
                                  max_length=1)),
                ('difficulty',
                 models.CharField(choices=[('B', 'Beginner'), ('I', 'Intermediate'), ('A', 'Advanced')], default='B',
                                  max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                'log_entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='exercise.ExerciseLog')),
            ],
        ),
        migrations.CreateModel(
            name='Workout',
        ...
        migrations.AddField(
            model_name='workout',
            name='exercise_list',
            field=models.ManyToManyField(through='exercise.WorkoutEntry', to='exercise.Exercise'),
        ),
        migrations.AddField(
            model_name='workout',
            name='routine',
